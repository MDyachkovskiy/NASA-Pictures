...
class ContactsListAdapter(
    ...
    private val callbackAdd: com.test.application.contacts.AddItem,
    private val callbackRemove: com.test.application.contacts.RemoveItem,
    private val callbackMove: com.test.application.contacts.MoveItem,
    private val callbackDragAndMove: com.test.application.contacts.DragAndMoveItem
