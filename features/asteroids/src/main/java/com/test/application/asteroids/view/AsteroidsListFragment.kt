package com.test.application.asteroids.view
...
import com.test.application.asteroids.adapter.AsteroidsListAdapter
import com.test.application.asteroids.databinding.FragmentAsteroidsListBinding
import com.test.application.asteroids.utils.KEY_BUNDLE_ASTEROID
...
class AsteroidsListFragment : BaseFragment<AsteroidsList, FragmentAsteroidsListBinding>(
    ...
    override fun onDestroyView() {
        binding.asteroidsList.adapter = null
        super.onDestroyView()
    }
}